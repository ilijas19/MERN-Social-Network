...
import WantsToFollowPopup from "../../components/profile/WantsToFollowPopup";
...
const UserProfile = () => {
  ...
  console.log(profile?.wantsToFollowMe);
  ...
  return (
    <>
      {/* Popup window */}
      <WantsToFollowPopup profile={profile} refetch={refetch} />
      <section>
        {/* GO BACK HEADER */}
